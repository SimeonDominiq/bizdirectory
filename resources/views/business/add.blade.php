...
@section('page-title', 'New Business')
...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">New Business Listing</h1>
    </div>
    ...
    <div class="row">
        <div class="col-xl-9 col-lg-9 mx-none mx-md-auto">
            <div class="card shadow">
                <div class="card-body">
                    <form action="{{ route('business.add') }}" class="user" method="POST">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="contact_person" class="form-control form-control-user" />
                                </div>
                            </div>                            
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="address" class="form-control form-control-user"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="website_url" class="form-control form-control-user" />
                                </div>                                
                            </div>
                        </div>
